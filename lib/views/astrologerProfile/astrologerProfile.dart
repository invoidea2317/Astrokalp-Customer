            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                      ...
                      children: [
                        GetBuilder<HomeController>(builder: (homeController) {
                          return InkWell(
                            ...
                            child: Stack(
                              children: [
                                CustomRoundNetworkImage(height: 120,width: 120,
                                  image : "${global.imgBaseurl}${bottomController.astrologerbyId[0].profileImage}",
                                ...
                                Positioned(
                                  ...
                                  child: CustomDecoratedContainer(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(bottomController.astrologerbyId[0].rating.toString(),
                                        ...
                                        sizedBoxW5(),
                                        Icon(Icons.star,
                                          color: Theme.of(context).primaryColor,size: Dimensions.fontSize14,
                                        )
                                      ],
                                    ),
                                  ),
                        ...
                        Flexible(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(bottomController.astrologerbyId[0].name.toString().toUpperCase(),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: openSansSemiBold.copyWith(
                                    fontSize: Dimensions.paddingSize20,
                                    color: Theme.of(context).cardColor
                                ),
                              ),
                              bottomController.astrologerbyId[0].languageKnown == ""
                                  ? const SizedBox()
                                  : CustomIconTextRowForAstrologer(
                                isWhite: true,
                                icon: Icons.translate, title: bottomController.astrologerbyId[0].languageKnown!,),
                              bottomController.astrologerbyId[0].allSkill == ""
                                  ? const SizedBox()
                                  : CustomIconTextRowForAstrologer(
                                isWhite: true,
                                icon: Icons.verified, title:    bottomController.astrologerbyId[0].allSkill!,),
                              CustomIconTextRowForAstrologer(icon: Icons.school,
                                isWhite: true,
                                title: 'Experience : ${bottomController.astrologerbyId[0].experienceInYears} Years',),
                              sizedBox10(),
                              GetBuilder<FollowAstrologerController>(builder: (followAstrologerController) {
                                return  CustomDecoratedContainer(
                                    horizontalPadding: Dimensions.paddingSize12,verticalPadding: Dimensions.paddingSize4,
                                    ...
                                    tap: () async {
                                      ...
                                      if (isLogin) {
                                        global.showOnlyLoaderDialog(context);
                                        await followAstrologerController.addFollowers(bottomNavigationController.astrologerbyId[0].id!);global.hideLoader();
                                      }
                                    },
                                    child: Text(bottomController.astrologerbyId[0].isFollow! ? 'Following' : '+ Follow',style: openSansRegular.copyWith(
                                        color: Theme.of(context).dividerColor,fontSize: Dimensions.fontSize14
                                    ),));
                ...
                Padding(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('About Astrologer',style: openSansRegular.copyWith(
                      ...
                      //       style: openSansRegular.copyWith(
                      //           fontSize: Dimensions.paddingSizeDefault,
                      //           color: Theme.of(context).dividerColor.withOpacity(0.70)
                      //       ),
                      //     ).tr())
                      Divider(color: Theme.of(context).dividerColor.withOpacity(0.30),),
                      Text('Consultation Charges',style: openSansRegular.copyWith(
                          fontSize: Dimensions.paddingSizeDefault
                      ),),
                      Text('${global.getSystemFlagValueForLogin(global.systemFlagNameList.currency)}${bottomController.astrologerbyId[0].charge}/min',
                        maxLines:userProfileController.isShowMore ? null : 2,
                        style:openSansSemiBold.copyWith(fontSize: Dimensions.fontSize20,
                        color: Theme.of(context).dividerColor.withOpacity(0.60)),
                      ).tr(),
                      Divider(color: Theme.of(context).dividerColor.withOpacity(0.30),),
                      Text('Location',style: openSansRegular.copyWith(fontSize: Dimensions.paddingSizeDefault),),
                      Text('${bottomController.astrologerbyId[0].currentCity}'.toUpperCase(),
                        maxLines:userProfileController.isShowMore ? null : 2,
                        style:openSansSemiBold.copyWith(fontSize: Dimensions.fontSize20,
                            color: Theme.of(context).dividerColor.withOpacity(0.60)),
                      ).tr(),
                      ...
                      return InkWell(
                        ...
                        child: Card(
                          ...
                          color: bottomNavigationController
                              ...
                              : Theme.of(context).dividerColor, //Get.theme.primaryColor,
                          elevation: 10,
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceAround,
                            children: [
                    ...
                    child:
                      ...
                      return InkWell(
                        ...
                        child: Card(
                          ...
                          color: bottomNavigationController.astrologerbyId[0].callStatus ==
                                  "Online"
                              ? primaryGreenColor
                              : primaryGreenColor,
                          //Get.theme.primaryColor,
                              ...
                              Center(
                                child: Column(
                                  ...
                                  children: [
                                    Column(
                                      children: [
                                        Text("Call", textAlign: TextAlign.center, style: TextStyle(color: Colors.white),).tr(),
